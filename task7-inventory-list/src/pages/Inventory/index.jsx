                        ...
                        { inventoryList.map((i) => 
                            <div key={i.id} className='px-4 py-2 w-full flex flex-col gap-2 bg-orange-50 hover:bg-orange-100'>
                                ...
                                <div className=' flex flex-row items-center justify-between'>
                                    ...
                                    <div className='flex flex-row gap-2'>
                                        <ButtonAction title='Edit' color='green-outline' action={() => handleShowEdit(i.id)} key={"btn-edit-" + i.id}>
                                            <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" className="w-4 h-4">
                                                <path strokeLinecap="round" strokeLinejoin="round" d="M16.862 4.487l1.687-1.688a1.875 1.875 0 112.652 2.652L10.582 16.07a4.5 4.5 0 01-1.897 1.13L6 18l.8-2.685a4.5 4.5 0 011.13-1.897l8.932-8.931zm0 0L19.5 7.125M18 14v4.75A2.25 2.25 0 0115.75 21H5.25A2.25 2.25 0 013 18.75V8.25A2.25 2.25 0 015.25 6H10" />
                                            </svg>
                                        </ButtonAction>
                                        <ButtonAction title='Delete' color='red-outline' action={() => handleDelete(i.id)} key={"btn-delete-" + i.id}>
                                            <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" className="w-4 h-4">
